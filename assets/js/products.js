const CONFIG = {
  facebookLink: "https://www.facebook.com/dezi1704"
};
...
const ICONS = {
  ...
  perplexity: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9" fill="#1FB6A6"></circle><path d="M8 16V8h5.3a3.2 3.2 0 0 1 0 6.4H10V16H8Zm2-3.4h3.1a1.6 1.6 0 0 0 0-3.2H10v3.2Z" fill="#fff"></path></svg>`,
  google: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9" fill="#ffffff"></circle><path d="M16.9 12.2c0-.4 0-.8-.1-1.2H12v2.3h2.8c-.1.7-.5 1.3-1.1 1.7v1.4h1.8c1.1-1 1.8-2.5 1.8-4.2Z" fill="#4285F4"></path><path d="M12 17c1.3 0 2.5-.4 3.4-1.2l-1.8-1.4c-.5.3-1 .5-1.6.5-1.2 0-2.3-.8-2.7-2H7.4v1.5A5 5 0 0 0 12 17Z" fill="#34A853"></path><path d="M9.3 12.9A3 3 0 0 1 9.1 12c0-.3.1-.6.2-.9V9.6H7.4A5 5 0 0 0 7 12c0 .8.2 1.6.4 2.4l1.9-1.5Z" fill="#FBBC05"></path><path d="M12 9.1c.7 0 1.4.2 1.9.7l1.4-1.4C14.5 7.5 13.3 7 12 7A5 5 0 0 0 7.4 9.6l1.9 1.5c.4-1.2 1.5-2 2.7-2Z" fill="#EA4335"></path></svg>`,
  duolingo: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9" fill="#58CC02"></circle><circle cx="9.5" cy="11" r="1.2" fill="#fff"></circle><circle cx="14.5" cy="11" r="1.2" fill="#fff"></circle><path d="M9 14.5c1.8 1 4.2 1 6 0" stroke="#fff" stroke-width="1.5" stroke-linecap="round" fill="none"></path></svg>`
};
